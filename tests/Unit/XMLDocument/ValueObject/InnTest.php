...
{
    // Провайдер данных: входные значения с пробелами/разделителями и ожидаемый очищенный результат
    ...
    // Тест для OrganizationInn: проверка очистки и нормализации ИНН
    #[DataProvider("getInn")]
    public function testOrganizationInn(string $input, string $expected): void
    {
        ...
        // Тест для EmployerInn: проверка очистки и нормализации ИНН (аналогично OrganizationInn)
    }   #[DataProvider("getInn")]
